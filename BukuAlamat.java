...
public class BukuAlamat
{
    ...
    int jumlah=0;
             ...
             do {
                try {
    System.out.println("MENU INPUT KE BUKU ALAMAT");
    ...
    case 1:
        ...
        System.out.println("Alamat                :"+namaRecord.getNoAlamat(i) );
        System.out.println("Telepon               :"+namaRecord.getTelpon(i) );
        System.out.println("Email                 :"+namaRecord.getEmail(i) );
        }
        System.out.println("\nData Telah Berhasil dimasukan");
        break;
    //AKHIR prosedur memasukan
    case 2:
        System.out.println("Menghapus Data");
        System.out.print("Input No yang Akan Dihapus: Input [1-"+jumlah+"]: ");
               try{
               n=dataIn.readLine();
               }catch(IOException e){
    ...
    case 4:
        ...
        System.out.print("Input No yang Akan Diubah datanya: Input [1-"+jumlah+"]: ");
               try{
               n=dataIn.readLine();
               }catch(IOException e){
               System.out.println("Erorr!");
        ...
        System.out.println("Telepon               :"+namaRecord.getTelpon(no) );
        System.out.println("Email                 :"+namaRecord.getEmail(no) );
        System.out.print("\nLanjutkan Proses Ubah Data? [y]/[t] :");
               try{
               yatidak=dataIn.readLine();
               }catch(IOException e){
               System.out.println("Erorr!");
